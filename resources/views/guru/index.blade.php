                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-header">
                                <a href="{{ route('guru.tambah') }}" class="btn btn-success">Tambah Data</a>
                            </div>
                            <div class="card-body">
                                            ...
                                            @foreach ($guru as $d)
                                                <tr>
                                                    ...
                                                    <td class="d-flex justify-content-between">
                                                        <a href="{{ route('guru.edit', $d->nip) }}" class="btn btn-primary btn-sm flex-fill mr-1">Edit</a>
                                                        <form onsubmit="return confirm('Yakin hapus data?');" method="POST" action="{{ route('guru.hapus', $d->nip) }}" class="flex-fill ml-1">
                                                            @csrf
                                                            @method('DELETE')
