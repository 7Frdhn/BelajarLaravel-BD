...
<head>
    ...
    <title>Tambah Data Guru | Manajemen-BD</title>
    <!-- AdminLTE CSS -->
                    ...
                    <form method="POST" action="{{ route('mapel.simpan') }}">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_mapel" class="form-control" id="kode_mapel" placeholder="Masukkan Kode Mata Pelajaran" required>
                            </div>
                            <div class="form-group">
                                <label for="namaMapel">Nama Mata Pelajaran</label>
                                <input type="text" name="nama_mapel" class="form-control" id="namaMapel" placeholder="Masukkan Nama Mata Pelajaran" required>
                                @error('nama_mapel')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="singkatan" class="form-control" id="singkatan" placeholder="Masukkan Singkatan" required>
                                @error('singkatan')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="pengajar" class="form-control" id="pengajar" placeholder="Masukkan Pengajar" required>
                                @error('pengajar')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('mapel.tampil') }}" class="btn btn-info">Kembali</a>
                        </div>
                    </form>
                </div>
            </div><!-- /.container-fluid -->
