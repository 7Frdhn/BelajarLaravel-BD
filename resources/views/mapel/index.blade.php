...
<head>
    ...
    <title>Data Guru | Manajemen-BD</title>
    <!-- AdminLTE CSS -->
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('mapel.tambah') }}" class="btn btn-success">Tambah Data</a>
                        </div>
                        <div class="card-body">
                                        ...
                                        @foreach ($mapel as $d)
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-between">
                                                    <a href="{{ route('mapel.edit', $d->kode_mapel) }}" class="btn btn-primary btn-sm flex-fill mr-1">Edit</a>
                                                    <form onsubmit="return confirm('Yakin hapus data?');" method="POST" action="{{ route('mapel.hapus', $d->kode_mapel) }}" class="flex-fill ml-1">
                                                        @csrf
                                                        @method('DELETE')
