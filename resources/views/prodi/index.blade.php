                                    ...
                                    <tbody>
                                        @foreach ($prodi as $d)
                                            <tr>
                                                ...
                                                <td>{{ $d->nama_prodi }}</td>
                                                <td>{{ $d->ketua_prodi }}</td>
                                                <td>{{ $d->status_prodi }}</td>
                                                <td>{{ $d->mulai_aktif }}</td>
                                                <td class="d-flex justify-content-between">
                                                    <a href="{{ route('prodi.edit', $d->id) }}" class="btn btn-primary btn-sm flex-fill mr-1">Edit</a>
                                                    <form onsubmit="return confirm('Yakin hapus data?');" method="POST" action="{{ route('prodi.destroy', $d->id) }}" class="flex-fill ml-1">
                                                        @csrf
                                                        @method('DELETE')
