                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('prodi.update', $prodi->id) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_prodi" name="nama_prodi" required value="{{ old('nama_prodi', $prodi->nama_prodi) }}">
                            </div>
                            <div class="form-group">
                                <label for="ketua_prodi">Ketua Prodi</label>
                                <input type="text" class="form-control" id="ketua_prodi" name="ketua_prodi" required value="{{ old('ketua_prodi', $prodi->ketua_prodi) }}">
                            </div>
                            <div class="form-group">
                                <label for="status_prodi">Status Prodi</label>
                                <select class="form-control" id="status_prodi" name="status_prodi" required>
                                    <option value="">------------</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="mulai_aktif" name="mulai_aktif" required value="{{ old('mulai_aktif', $prodi->mulai_aktif) }}">
                            </div>
