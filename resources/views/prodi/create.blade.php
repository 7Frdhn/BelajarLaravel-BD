    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah Data Prodi</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                    ...
                    <form method="POST" action="{{ route('prodi.store') }}">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_prodi" class="form-control" id="kodeProdi" placeholder="Masukkan Kode Prodi" required>
                            </div>
                            <div class="form-group">
                                <label for="namaProdi">Nama Prodi</label>
                                <input type="text" name="nama_prodi" class="form-control" id="namaProdi" placeholder="Masukkan Nama Prodi" required>
                                @error('nama_prodi')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="ketuaProdi">Ketua Prodi</label>
                                <input type="text" name="ketua_prodi" class="form-control" id="ketuaProdi" placeholder="Masukkan Nama Ketua Prodi" required>
                                @error('ketua_prodi')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                <label for="statusProdi">Status Prodi</label>
                                <select name="status_prodi" class="form-control" id="statusProdi" required>
                            ...
                            <div class="form-group">
                                <label for="mulaiAktif">Mulai Aktif</label>
                                <input type="date" name="mulai_aktif" class="form-control" id="mulaiAktif" required>
                            </div>
                        </div>
                        <!-- /.card-body -->
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('prodi.index') }}" class="btn btn-info">Kembali</a>
                        </div>
                    </form>
                </div>
            </div><!-- /.container-fluid -->
